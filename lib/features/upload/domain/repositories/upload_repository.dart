...
class UploadRepository{
  ...
  Future<Result> uploadVideo(XFile video) async {
    ...
    try{
      ...
      final videoMoel = VideoModel(id: "id", uploaderId: userId, userNickName: "nic", title: "title", description: "description", videoUrl: downloadUrl, thumbnailUrl: "thumbnailUrl", views: 0, categoryId: "categoryId", createdAt: DateTime.now(), updatedAt: DateTime.now());
      // Firestore에 정보 저장
